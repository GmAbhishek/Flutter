        ...
        body: (contacts) == null
            ...
            : ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  String num = (contacts![index].phones.isNotEmpty)? /*(contacts![index].displayName)*/(contacts![index].phones.first.number): "--";
                  ...
                  return ListTile(
                      ...
                      title: Text(
                          "${contacts![index].name} ${contacts![index].emails}"),
                      subtitle: Text(contacts![index].displayName),
                      onTap: () {
